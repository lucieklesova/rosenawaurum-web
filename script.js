...
const translations = {
  cs: {
    ...
    litterInvitationEyebrow: "Plánovaný vrh Alminky",
    litterInvitationTitle: "Nezávazná čekací listina je otevřená",
    litterInvitationText: "Pokud vás Alminka oslovila, budeme rádi, když se nám ozvete už teď. Napište pár vět o sobě, o svém domově a o tom, jaký společný život si se štěnětem představujete. Rádi vás poznáme osobně – klidně se u nás ve Viganticích zastavte.",
    litterInvitationSire: "<strong>Krycího psa už máme vybraného.</strong> Zatím ho veřejně nepředstavujeme, ale zájemcům o štěně o plánovaném spojení rádi řekneme víc.",
    litterInvitationCta: "Napsat nám pár slov",
    litterInvitationPhone: "Nebo nám zavolejte",
    litterTimelineTitle: "Předběžný harmonogram",
    litterTimelineHeatTitle: "Konec srpna / začátek září 2026",
    litterTimelineHeatText: "předběžně očekáváme další hárání Alminky",
    litterTimelinePlanTitle: "Konec února / začátek března 2027",
    litterTimelinePlanText: "předběžně plánované krytí",
    litterTimelinePuppiesTitle: "Začátek května 2027",
    litterTimelinePuppiesText: "při potvrzeném krytí očekáváme narození štěňátek",
    litterTimelineHomeTitle: "V červenci 2027",
    litterTimelineHomeText: "nejdříve v 8 týdnech mohou štěňátka odcházet do nových rodin",
    litterTimelineDisclaimer: "Termíny jsou orientační a mohou se změnit podle zdraví a přirozeného průběhu.",
    ...
    // Výstavy Split 2026
    artSplitCat: "Výstavy",
    artSplitTitle: "Výstavní víkend ve Splitu – Alma 3× V4",
    artSplitQuote: "Ne každá výstava musí skončit pohárem, aby měla obrovskou hodnotu.",
    artSplitP1: 'Celý víkend jsme strávily na <strong>4 Night Dog Shows</strong> v&nbsp;chorvatském Splitu. Alminka během čtyř večerních výstav v&nbsp;otevřené třídě získala hned <strong>3× V4</strong> – a&nbsp;každé posouzení nám dává zpětnou vazbu, motivaci pracovat dál a&nbsp;posouvat se zase o&nbsp;kousek blíž našim cílům.',
    artSplitResultAlma: '<strong>Alma Bohemica Aurum</strong><br><em>(Brandon de Ria Vela × Lollipop Dorado Blanco)</em><br>Otevřená třída • 4 Night Dog Shows, Split, Chorvatsko<br><strong>3× V4 – Výborná 4</strong>',
    artSplitResultEssie: '<strong>Essie</strong> <em>(chovatelská stanice <a href="https://www.beskydhill.com/kopie-vrh-c" target="_blank" rel="noopener noreferrer">Beskyd Hill</a>)</em><br>Třída dorostu • <strong>BOJ – Best of Junior</strong><br><span>Vystavovala: Lucie Klesová</span>',
    artSplitP2: 'Na Alminku jsem moc pyšná. Pro mě byla velká čest dostat příležitost vystavit krásnou <strong>Essie</strong> a&nbsp;společně s&nbsp;ní vyběhat titul BOJ – byla to moje první zkušenost běhat s&nbsp;jiným pejskem než s&nbsp;Alminkou.',
    artSplitP3: 'Obrovské poděkování patří <strong>Janě z&nbsp;Beskyd Hill</strong> a&nbsp;úžasnému <strong>Ondrovi z&nbsp;Athena Bella</strong> – za veškerou pomoc, perfektní servis, výborné jídlo, spoustu smíchu, podpory a&nbsp;skvělé společnosti během celého víkendu. Díky vám to byl zážitek, na který budu dlouho vzpomínat. Zároveň obrovská gratulace k&nbsp;fantastickým výsledkům vašich pejsků!',
    artSplitP4: 'Děkuji všem, se kterými jsme tenhle výstavní víkend mohli strávit. Už teď se těším na další společná setkání.',
    newsMonthSplit: "Srp",
    newsTitleSplit: "Výstavní víkend ve Splitu – Alma 3× V4",
    newsExcerptSplit: "Alminka na 4 Night Dog Shows ve Splitu získala 3× V4. První BOJ s Essie z Beskyd Hill a víkend plný zážitků.",
    newsListMonthSplit: "Srp",
    newsListExcerptSplit: "Alminka na 4 Night Dog Shows ve Splitu získala 3× V4. První BOJ s Essie z Beskyd Hill a víkend plný zážitků u Jaderského moře.",
    splitRelatedTitle: "Mohlo by vás také zajímat",
    splitRelatedProvodoviceMeta: "28. 3. 2026 · Výstavy",
    splitRelatedProvodoviceTitle: "Alma poprvé v otevřené třídě – Provodovice",
    ...
    contactFaqHint: "Než napíšete, podívejte se také do",
    contactFaqLink: "častých otázek",
  ...
  en: {
    ...
    litterInvitationEyebrow: "Alma's planned litter",
    litterInvitationTitle: "Our no-obligation waiting list is open",
    litterInvitationText: "If Alma has captured your heart, we would love to hear from you now. Tell us a little about yourself, your home and the life you imagine with a puppy. We would be happy to meet you in person – you are welcome to visit us in Vigantice.",
    litterInvitationSire: "<strong>We have already chosen the stud dog.</strong> We are not introducing him publicly just yet, but we will be happy to tell prospective puppy families more about the planned pairing.",
    litterInvitationCta: "Tell us a little about you",
    litterInvitationPhone: "Or give us a call",
    litterTimelineTitle: "Preliminary timeline",
    litterTimelineHeatTitle: "Late August / early September 2026",
    litterTimelineHeatText: "we tentatively expect Alma's next season",
    litterTimelinePlanTitle: "Late February / early March 2027",
    litterTimelinePlanText: "tentatively planned mating",
    litterTimelinePuppiesTitle: "Early May 2027",
    litterTimelinePuppiesText: "if the mating is confirmed, we expect the puppies to be born",
    litterTimelineHomeTitle: "In July 2027",
    litterTimelineHomeText: "puppies may leave for their new homes no earlier than at 8 weeks of age",
    litterTimelineDisclaimer: "Dates are indicative and may change according to health and the natural course of events.",
    ...
    // Split dog shows 2026
    artSplitCat: "Shows",
    artSplitTitle: "Show weekend in Split – Alma 3× Excellent 4",
    artSplitQuote: "Not every show has to end with a trophy to be hugely valuable.",
    artSplitP1: 'We spent the whole weekend at the <strong>4 Night Dog Shows</strong> in Split, Croatia. Across four evening shows, Alma earned <strong>3× Excellent 4</strong> in the open class. Every assessment gives us feedback, motivation to keep working and another small step closer to our goals.',
    artSplitResultAlma: '<strong>Alma Bohemica Aurum</strong><br><em>(Brandon de Ria Vela × Lollipop Dorado Blanco)</em><br>Open class • 4 Night Dog Shows, Split, Croatia<br><strong>3× Excellent 4</strong>',
    artSplitResultEssie: '<strong>Essie</strong> <em>(<a href="https://www.beskydhill.com/kopie-vrh-c" target="_blank" rel="noopener noreferrer">Beskyd Hill</a> kennel)</em><br>Puppy class • <strong>BOJ – Best of Junior</strong><br><span>Handled by: Lucie Klesová</span>',
    artSplitP2: 'I am very proud of Alma. It was a great honour to be given the chance to show the beautiful <strong>Essie</strong> and win the BOJ title with her – my first experience of handling a dog other than Alma.',
    artSplitP3: 'A huge thank-you goes to <strong>Jana from Beskyd Hill</strong> and the wonderful <strong>Ondra from Athena Bella</strong> for all their help, perfect care, excellent food, plenty of laughter, support and great company throughout the weekend. You made it an experience I will remember for a long time. And huge congratulations on the fantastic results of your dogs!',
    artSplitP4: 'Thank you to everyone we could share this show weekend with. I am already looking forward to our next meetings.',
    newsMonthSplit: "Aug",
    newsTitleSplit: "Show weekend in Split – Alma 3× Excellent 4",
    newsExcerptSplit: "At the 4 Night Dog Shows in Split, Alma earned 3× Excellent 4. A first BOJ with Essie from Beskyd Hill and a weekend full of great moments.",
    newsListMonthSplit: "Aug",
    newsListExcerptSplit: "At the 4 Night Dog Shows in Split, Alma earned 3× Excellent 4. A first BOJ with Essie from Beskyd Hill and a weekend full of great moments by the Adriatic Sea.",
    splitRelatedTitle: "You may also like",
    splitRelatedProvodoviceMeta: "28 Mar 2026 · Shows",
    splitRelatedProvodoviceTitle: "Alma's first open class – Provodovice",
    ...
    contactFaqHint: "Before you write, take a look at our",
    contactFaqLink: "frequently asked questions",
  ...
  de: {
    ...
    litterInvitationEyebrow: "Almas geplanter Wurf",
    litterInvitationTitle: "Unsere unverbindliche Warteliste ist geöffnet",
    litterInvitationText: "Wenn Alma Sie begeistert hat, freuen wir uns schon jetzt über Ihre Nachricht. Erzählen Sie uns ein paar Worte über sich, Ihr Zuhause und das Leben, das Sie sich mit einem Welpen vorstellen. Wir lernen Sie gerne persönlich kennen – besuchen Sie uns doch in Vigantice.",
    litterInvitationSire: "<strong>Den Deckrüden haben wir bereits ausgewählt.</strong> Wir stellen ihn noch nicht öffentlich vor, erzählen Interessenten an einem Welpen aber gerne mehr über die geplante Verpaarung.",
    litterInvitationCta: "Erzählen Sie uns von sich",
    litterInvitationPhone: "Oder rufen Sie uns an",
    litterTimelineTitle: "Vorläufiger Zeitplan",
    litterTimelineHeatTitle: "Ende August / Anfang September 2026",
    litterTimelineHeatText: "voraussichtlich erwarten wir Almas nächste Läufigkeit",
    litterTimelinePlanTitle: "Ende Februar / Anfang März 2027",
    litterTimelinePlanText: "vorläufig geplante Deckung",
    litterTimelinePuppiesTitle: "Anfang Mai 2027",
    litterTimelinePuppiesText: "bei bestätigter Deckung erwarten wir die Geburt der Welpen",
    litterTimelineHomeTitle: "Im Juli 2027",
    litterTimelineHomeText: "frühestens mit 8 Wochen dürfen die Welpen in ihre neuen Familien ziehen",
    litterTimelineDisclaimer: "Die Termine sind vorläufig und können sich je nach Gesundheit und natürlichem Verlauf ändern.",
    ...
    // Ausstellungen Split 2026
    artSplitCat: "Ausstellungen",
    artSplitTitle: "Ausstellungswochenende in Split – Alma 3× V4",
    artSplitQuote: "Nicht jede Ausstellung muss mit einem Pokal enden, um einen großen Wert zu haben.",
    artSplitP1: 'Das ganze Wochenende verbrachten wir bei den <strong>4 Night Dog Shows</strong> im kroatischen Split. Alma erhielt bei vier Abend-Ausstellungen in der offenen Klasse gleich <strong>3× V4</strong>. Jede Beurteilung gibt uns Feedback, Motivation weiterzuarbeiten und bringt uns unseren Zielen wieder ein kleines Stück näher.',
    artSplitResultAlma: '<strong>Alma Bohemica Aurum</strong><br><em>(Brandon de Ria Vela × Lollipop Dorado Blanco)</em><br>Offene Klasse • 4 Night Dog Shows, Split, Kroatien<br><strong>3× V4 – Vorzüglich 4</strong>',
    artSplitResultEssie: '<strong>Essie</strong> <em>(Zuchtstätte <a href="https://www.beskydhill.com/kopie-vrh-c" target="_blank" rel="noopener noreferrer">Beskyd Hill</a>)</em><br>Jüngstenklasse • <strong>BOJ – Bester Junghund</strong><br><span>Vorgeführt von: Lucie Klesová</span>',
    artSplitP2: 'Ich bin sehr stolz auf Alma. Es war für mich eine große Ehre, die wunderschöne <strong>Essie</strong> ausstellen und mit ihr den BOJ-Titel gewinnen zu dürfen – meine erste Erfahrung, mit einem anderen Hund als Alma im Ring zu laufen.',
    artSplitP3: 'Ein riesiges Dankeschön geht an <strong>Jana von Beskyd Hill</strong> und den großartigen <strong>Ondra von Athena Bella</strong> für alle Hilfe, den perfekten Service, das ausgezeichnete Essen, viel Lachen, Unterstützung und die tolle Gesellschaft während des ganzen Wochenendes. Ihr habt daraus ein Erlebnis gemacht, an das ich mich lange erinnern werde. Und herzlichen Glückwunsch zu den fantastischen Ergebnissen eurer Hunde!',
    artSplitP4: 'Danke an alle, mit denen wir dieses Ausstellungswochenende verbringen durften. Ich freue mich schon jetzt auf die nächsten gemeinsamen Treffen.',
    newsMonthSplit: "Aug",
    newsTitleSplit: "Ausstellungswochenende in Split – Alma 3× V4",
    newsExcerptSplit: "Alma erhielt bei den 4 Night Dog Shows in Split 3× V4. Ein erster BOJ mit Essie von Beskyd Hill und ein Wochenende voller schöner Erlebnisse.",
    newsListMonthSplit: "Aug",
    newsListExcerptSplit: "Alma erhielt bei den 4 Night Dog Shows in Split 3× V4. Ein erster BOJ mit Essie von Beskyd Hill und ein Wochenende voller schöner Erlebnisse an der Adria.",
    splitRelatedTitle: "Das könnte Sie auch interessieren",
    splitRelatedProvodoviceMeta: "28. 3. 2026 · Ausstellungen",
    ...
    contactFaqHint: "Bevor Sie schreiben, schauen Sie auch in unsere",
    contactFaqLink: "häufig gestellten Fragen",
    formNameLabel: "Name",
    formEmailLabel: "E‑Mail",
    formPhoneLabel: "Telefon",
